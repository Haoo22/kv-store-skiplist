...
1. 先看 [thesis_materials.md](../thesis_materials.md)
2. 再看 [benchmark_methodology.md](../benchmark_methodology.md)
3. 如果需要线程池反例，优先看 [thread_pool_findings.md](../internal/thread_pool_findings.md)
...
- 实验统计口径：优先引用 [benchmark_methodology.md](../benchmark_methodology.md)
- 线程池反例结论：优先引用 [thread_pool_findings.md](../internal/thread_pool_findings.md)
